...
class Crawler:
    ...
    def __init__(self):
        '''
            爬虫需要的字段https://www.cltt.me
        '''
        # self.url = 'https://www.sky2023.xyz/search/苍井空_ctime_1.html'
        self.url = 'https://www.sky2023.xyz'
        self.headers = {
...
class App:
    ...
    def clickSearch(self):
        content = self.text1.get().strip()
        if content == '':
            messagebox.showinfo(title='Error', message='content can\'t be empty!')
        else:
