...
async def get_blog(id):
    ...
    for c in comments:
        c.html_content = markdown.markdown(c.content, extensions=['extra', 'codehilite', 'fenced_code'])
    blog.html_content = markdown.markdown(blog.content, extensions=['extra', 'codehilite', 'fenced_code'])
    return {
